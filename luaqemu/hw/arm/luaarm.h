...
typedef struct {
    ...
    int do_interrupt_cb;  /* called before arm_cpu_do_interrupt_aarch32 */
    int post_do_interrupt_cb;  /* called after arm_cpu_do_interrupt_aarch32 */
