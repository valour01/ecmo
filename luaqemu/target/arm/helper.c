                             ...
                             ARMMMUFaultInfo *fi)
{
    ...
    /*versatile vic*/
    if (address>=0xf1140000){
            if (address < 0xf1140000+0x1000){
                    *phys_ptr = (address & 0x00000fff)+0x10140000;
                    *page_size = 0x1000;
                    *prot |=PAGE_READ;
                    *prot |=PAGE_EXEC;
                    *prot |=PAGE_WRITE;
    ...
    /*versatile timer*/
    if (address>=0xf11e0000){
            if (address<0xf11e0000+0x9000){
                    *phys_ptr = (address-0xf11e0000)+0x101e0000;
                    *page_size = 0x9000;
                    *prot |=PAGE_READ;
                    *prot |=PAGE_EXEC;
                    *prot |=PAGE_WRITE;
                             ...
                             target_ulong *page_size, ARMMMUFaultInfo *fi)
{
    ...
    if (address>=0xf0000000){
            if (address<0xf0000000+0x100){
                    *phys_ptr = (address-0xf0000000)+0x44200000;
                    *page_size = 0x100;
                    *prot |=PAGE_READ;
                    *prot |=PAGE_EXEC;
                    *prot |=PAGE_WRITE;
